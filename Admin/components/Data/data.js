...
export const sidebarButtonLists = [
  ...
  { id: 4, name: "Dispatchers", pathname: "/dispatchers", Icon: <HailIcon /> },

  {
    id: 5,
    name: "Manual Booking",
    pathname: "/manual_booking",
    Icon: <EditSharp />,
  },
  {
    id: 6,
    name: "Vehicle Type",
    pathname: "/vehicle_type",
    Icon: <LocalTaxi />,
  },
  { id: 7, name: "Report", pathname: "/report", Icon: <Report /> },
  {
    id: 8,
    name: "Review & Rating",
    pathname: "/review_and_rating",
    Icon: <RateReview />,
  },
  {
    id: 9,
    name: "Register Driver",
    pathname: "/register_driver",
    Icon: <Add />,
  },
  {
    id: 10,
    name: "Register Dispatcher",
    pathname: "/register_dispatcher",
    Icon: <Add />,
  },
  {
    id: 11,
    name: "Remove Driver",
    pathname: "/remove_driver",
    Icon: <Remove />,
  },
  {
    id: 12,
    name: "Remove Dispatcher",
    pathname: "/remove_dispatcher",
    Icon: <Remove />,
  },
