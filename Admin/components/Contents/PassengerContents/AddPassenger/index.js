          ...
          <form onSubmit={submitFormHandler} className={classes.form}>
            <div className={classes.formControl}>
              <label className={classes.label} htmlFor="firstName">
                First Name: <span className={classes.alert}>*</span>
              </label>
              <input
                value={firstName}
            ...
            <div className={classes.formControl}>
              <label className={classes.label} htmlFor="lastName">
                Last Name: <span className={classes.alert}>*</span>
              </label>
              <input
                value={lastName}
            ...
            <div className={classes.formControl}>
              <label className={classes.label} htmlFor="email">
                Email: <span className={classes.alert}>*</span>
              </label>
              <input
                value={email}
            ...
            <div className={classes.formControl}>
              <label className={classes.label} htmlFor="city">
                City: <span className={classes.alert}>* {cityError}</span>
              </label>
              <input
                value={city}
            ...
            <div className={classes.formControl}>
              <label className={classes.label} htmlFor="adress">
                Address: <span className={classes.alert}>* </span>
              </label>
